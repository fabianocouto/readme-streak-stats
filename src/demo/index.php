...
<head>
    ...
    <link rel="stylesheet" href="./css/style.css?v=<?= filemtime(dirname(__DIR__, 1) . "/demo/css/style.css") ?>">
    <link rel="stylesheet" href="./css/toggle-dark.css?v=<?= filemtime(dirname(__DIR__, 1) . "/demo/css/toggle-dark.css") ?>">
    ...
    <script type="text/javascript" src="./js/script.js?v=<?= filemtime(dirname(__DIR__, 1) . "/demo/js/script.js") ?>" defer></script>
    <script type="text/javascript" src="./js/accordion.js?v=<?= filemtime(dirname(__DIR__, 1) . "/demo/js/accordion.js") ?>" defer></script>
    <script type="text/javascript" src="./js/toggle-dark.js?v=<?= filemtime(dirname(__DIR__, 1) . "/demo/js/toggle-dark.js") ?>" defer></script>
    <script type="text/javascript" src="./js/jscolor.min.js?v=<?= filemtime(dirname(__DIR__, 1) . "/demo/js/jscolor.min.js") ?>" defer></script>
